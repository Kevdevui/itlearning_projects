...
# Test the word frequency counter with updated text
text = "Here is another example text. This text has various words. Some words appear more than once, like 'text' and 'words'."
